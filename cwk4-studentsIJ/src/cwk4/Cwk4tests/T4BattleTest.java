 ...
 * @author aam
 *
 * The reason behind some of the methods not working is that i made the code better, rather than automatically making the admiral lose if he/she
 * chooses the wrong force, I made it show an error, making the admiral make the choice again with an adequate force this time
 */
